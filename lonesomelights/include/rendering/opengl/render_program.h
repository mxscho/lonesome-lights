...
public:
	...
	void set_uniforms(const std::string& view_transformation_uniform_name, const std::string& projection_transformation_uniform_name, const std::string& camera_eye_position_uniform_name, const std::string& camera_up_direction_uniform_name, const std::string& camera_look_direction_uniform_name, const Camera& camera) const;
	void destroy();
private:
	bool m_is_generated;
public:
